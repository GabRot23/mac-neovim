...
vim.keymap.set('n', '<C-p>', '<cmd>lua require("telescope.builtin").find_files({ no_ignore = false, hidden = true })<cr>',
  opts)
vim.keymap.set('n', '<C-r>', '<cmd>lua require("telescope.builtin").live_grep()<cr>',
  opts)
